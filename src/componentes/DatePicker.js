...
const ContenedorInput = styled.div`
    ...
    //Esto es para cambiar el ancho de todos los elementos cuando se trabaje con pantallas pequeñas y que de esa manera se vena mejor
...
const DatePicker = ({fecha, cambiarFecha}) => {
    return (  
        <ContenedorInput>
            <DayPickerInput
                value={fecha}
                //Esto se ejecuta cuando cambies el día en tu calendrio
