...
const SelectCategorias = ({categoria, cambiarCategoria}) => {
    ...
    const handleClick = (event) => {
        //Aquí se coloca currentTarget en vez de "target" porque "Opcion" se encuentra dentro de otro elemento. O sea, el elemento al que vas a hacer click se encuentra dentro de otro elemento
        cambiarCategoria(event.currentTarget.dataset.valor);
    }
    return (  
